from archive import utilities as util
...
test_mouse_table_seed = [(9990, birthdate2, 'wild type', 'male', True, 'test the_experiment one', start1, end1),
                         (9991, birthdate1, 'wild type', 'male', False, 'test the_experiment two', start2, end2),
                         (9992, birthdate1, 'wild type', 'male', True, 'test the_experiment one', start1, end1),
                         (9993, birthdate1, 'wild type', 'male', False, 'test the_experiment two', start2, end2),
                         (9994, birthdate1, 'wild type', 'female', True, 'test the_experiment one', start1, end1),
                         (9995, birthdate1, 'wild type', 'female', False, 'test the_experiment two', start2, end2),
                         (9996, birthdate1, 'knock out', 'female', True, 'test the_experiment one', start1, end1),
                         (9997, birthdate1, 'knock out', 'female', False, 'test the_experiment two', start2, end2),
                         (9998, birthdate1, 'knock out', 'female', True, 'test the_experiment one', start1, end1),
                         (9999, birthdate2, 'knock out', 'female', False, 'test the_experiment two', start2, end2)]

exp_one = ('test the_experiment one', '/test/directory/the_experiment/one')
exp_two = ('test the_experiment two', '/test/directory/the_experiment/two')
