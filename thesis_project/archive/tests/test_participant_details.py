...
from archive import database as seeds
...
Postgresql = tpg.PostgresqlFactory(cache_initialized_db=True,
                                   on_initialized=archive.database.handlers.handlers.handler_create_participant_details)
...
class TestNewParticipantDetails(unittest.TestCase):
    ...
    def setUp(self):
        ...
        archive.database.handlers.handlers.handler_seed_participant_details(self.postgresql)
