...
from archive.database import test_blind_review_reviewers_seed as reviewer_seed
from archive.models import Reviewer

Postgresql = tpg.PostgresqlFactory(cache_initialized_db=True,
                                   on_initialized=archive.database.handlers.handlers.handler_create_reviewers_table)
