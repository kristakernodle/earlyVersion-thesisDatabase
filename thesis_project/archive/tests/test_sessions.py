...
from archive import utilities as utils
from archive.database import test_mouse_table_seed, test_session_table_seed

Postgresql = tpg.PostgresqlFactory(cache_initialized_db=True,
                                   on_initialized=archive.database.handlers.handlers.handler_create_sessions_table)
